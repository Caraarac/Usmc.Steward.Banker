...
namespace Usmc.Steward.Banker.Data;

public class BankerTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<BankerTenantDatabaseMigrationHandler> _logger;

    public BankerTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<BankerTenantDatabaseMigrationHandler> logger)
    {
