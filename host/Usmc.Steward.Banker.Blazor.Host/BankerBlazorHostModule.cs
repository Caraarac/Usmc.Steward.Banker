...
using Usmc.Steward.Banker.Blazor.WebAssembly;
...
namespace Usmc.Steward.Banker.Blazor.Host;
...
[DependsOn(
    ...
    typeof(BankerBlazorWebAssemblyModule)
)]
public class BankerBlazorHostModule : AbpModule
{
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new BankerHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("Banker");
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<BankerBlazorHostModule>();
        });
    }
}
